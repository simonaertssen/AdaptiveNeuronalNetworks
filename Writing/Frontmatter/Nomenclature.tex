...
& \Sin(t)_i, \Sout(t)_j\quad &&\text{Spike trains received and emitted by neuron $i$ as a sum of delta functions in time.}\\ 
...
&  \C && \text{Set in the complex unit circle so that $\C = \{ z: \rvert z \rvert \leq 1 \} $.} \\ \\
