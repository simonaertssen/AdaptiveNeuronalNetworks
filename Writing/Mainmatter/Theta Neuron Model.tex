...
When $I$ is not static, we need to revert to numerical solutions. For this work, a fixed-step 4-stage Runge-Kutta method was implemented (Dormand-Prince 45) to numerically solve all differential equations. A fixed-step algorithm makes it possible to finely tune the large memory demand of the systems presented in this work. 
