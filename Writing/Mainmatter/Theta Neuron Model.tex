...
\begin{align}
\dot{\theta} = (1-\cos \theta)+(1+\cos \theta) \cdot I \label{eq:thetaneuron}
\end{align}
...
\caption{Properties of the theta neuron model, expressed in $1 + \cos \theta$ to express the pulse-shaped caracteristic. Left: the spike frequency of $\theta$ increases as $I$ is increased over time, which is the distinguishing feature of class 1 canonical models. Middle and Right:}
