...
\end{align}
This process has been visualised in Figure \ref{fig:ThetaNeuronfIandPRC}, after \cite{Perez2020}. For infinitesimally small perturbations to the phase, we can find the \PRC as the \textsl{adjoint} of the solution \cite{Gutkin2014}:
\begin{align}
