...
\caption{Frequency response of the theta model, with theoretical results in blue, and experimental results in black dots. For $I \leq 0$ the spike period is infinite, which is why we see the .}
...
\end{align*}
Hence, a 1\% change in $I$ will result in a 0.5 \% change in the period. In Figure \ref{fig:ThetaNeuronResponseToCurrentPeriod} the frequency $\frac{1}{T}$ is measured and plotted in function of the current.
