...
For random networks, the results in Figure \ref{fig:InspectMeanFieldRandom} are also consistent, with a little more deviation in the \CPW state.
\begin{figure}[H]
\centering
