...
\rfoot{\footnotesize \textcolor{Gray}{\thesisauthor, \thedate}}
\fancyhfoffset{0pt}
...
\newcommand{\kinb}{{\boldsymbol{k^{\rm in}}}\xspace}
\newcommand{\koutb}{\boldsymbol{{k^{\rm out}}}\xspace}
...
% Author macros:
\newcommand{\thesistitle}{Dynamics of adaptive neuronal networks}
\newcommand{\thesissubtitle}{A trip to topology and back}
\newcommand{\mywork}{{\textsl{Investigation:}}\xspace}

\newcommand{\thesisauthor}{Simon Aertssen} % Your name :) 
\newcommand{\studentnumber}{s181603}
\newcommand{\thedate}{February 1$^{\text{st}}$ 2020 } 
