...
\newcommand{\theory}{{\textsl{Theory:}}\xspace}
...
\newcommand{\departmentwebsite}{\href{https://www.compute.dtu.dk/}{www.compute.dtu.dk}}

%thetas:            blue       '#0072BD' [0 0.4470 0.7410]
%Z_A_ij:            blue       '#0072BD' [0 0.4470 0.7410]
%Z_MF:              black      '#000000' [0 0.0000 0.0000]
%
%Z_fixeddegree:     light blue '#4DBEEE' [0.3010 0.7450 0.9330]
%Z_random:          green      '#77AC30' [0.4660 0.6740 0.1880]
%Z_scalefree:       dark red   '#A2142F' [0.6350 0.0780 0.1840]
%
%W_K:  green     '#298A3E'
%W_S:  orange    '#D95319' [0.8500 0.3250 0.0980]
%W_C:  yellow    '#EDB120' [0.9290 0.6940 0.1250]
