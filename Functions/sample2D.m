...
%March 2012
%
%[x0,y0]=sample2D(Xin,Yin,dist_in,varargin);
%
...
% vals=zeros(2,N);
% for i=1:N
%    [vals(1,i),vals(2,i)]=sample2D(Xin,Yin,Dist);
% end
%
% figure;
% hold on
...
% vals=zeros(2,N);
% for i=1:N
%    [vals(1,i),vals(2,i)]=sample2D(Xin,Yin,Dist,res);
% end
%
% figure;
% hold on
...
function [x0,y0]=sample2D(Xin,Yin,dist_in,varargin)
